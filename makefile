...
MYCFLAGS= $(LOCAL) -std=c99 -DLUA_USE_LINUX #COMMENTING OUT AS THIS REQUIRES EXTERNAL LIBRARIES# -DLUA_USE_READLINE
MYLDFLAGS= $(LOCAL) -Wl,-E
MYLIBS= -ldl #COMMENTING OUT AS THIS REQUIRES EXTERNAL LIBRARIES# -lreadline
